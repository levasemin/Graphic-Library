...
namespace SL
{
    ...
    public:
        ...
        DecoratorScrollBar(Widget *widget) : Decorator(widget),
            scroll_bar_vertical_  (Vector2d(20, widget->get_shape().y_), Vector2d(widget->get_position().x_ + widget->get_shape().x_ + 10, widget->get_position().y_), 0.f, 1.f),
            scroll_bar_horizontal_(Vector2d(widget->get_shape().x_, 20), Vector2d(widget->get_position().x_, widget->get_position().y_ + widget->get_shape().y_ + 10), 0.f, 1.f)
        {   
