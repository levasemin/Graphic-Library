...
{          
    ...
    Command<const booba::Event&> *command = (Command<const booba::Event &> *)new SimpleCommand<Button, const Event&>(&first_button, &Button::print);
    ...
    Canvas canvas(Vector2d(100, 100), Vector2d(600, 600), image);
