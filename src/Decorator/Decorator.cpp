...
// namespace SL
// {
//     Decorator::Decorator (Widget *widget, Vector2d shape, Vector2d position): 
//         CompositeObject(shape, position),
//         widget_(widget)
//     {
//     }

//     Decorator::Decorator(const Decorator &source) : CompositeObject(source)
//     {
...
//     Decorator::Decorator(Decorator &&source) : CompositeObject(std::move(source))
//     {
//         widget_ = source.widget_;
//     }
...
//     {
//         CompositeObject::operator=(std::move(source));
//         widget_ = source.widget_;
//         return *this;
//     }
